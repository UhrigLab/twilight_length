...
#            self.names = 'genotypes.txt'
    ...
    img1 = pcv.white_balance(img,roi=(1315, 870, 25, 25))             
    ...
    rotate_img = pcv.rotate(img1, -2.5, True)
    ...
    for j in range(7):
        for i in range(4):
            if i<4:
                coord.append((445+i*243,130+j*235))
            else:
...
# 0 6 12 18 24 30
# 3, 9, 15, 21, 27, 33...
    roi_order = np.array([0,4,8,12,16,20, 2,6,10,14,18,22, 1,5,9,13,17,21, 3,7,11,15,19,23])
